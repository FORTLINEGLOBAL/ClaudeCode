...
<a href="<?php echo home_url('/customers/'); ?>#contact" onclick="this.parentElement.classList.remove('open')" class="btn-gold" style="margin-top:1rem">Contact Us</a>
  ...
  <section class="hero">
    <div class="container">
      ...
      <h1 class="fade-in">About ARI Engineering</h1>
